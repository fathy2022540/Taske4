...
namespace Taske4
{
    ...
    {
        public SavingsAccount(string name = "Unnamed Account", double balance = 0.0, double fee = 3.0) :base(name, balance) 
        {
            Fee = fee;
        }
    ...
    {
        public TrustAccount(string name = "Unnamed Account", double balance = 0.0, double fee = 5) : base(name, balance)
        {
            Fee = fee;
        }
        public double Fee { get; set; }
